...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="<?php echo base_url().'user/home'?>" class="navbar-brand d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?php echo base_url().'user/home'?>" class="nav-item nav-link">Beranda</a>
                <a href="<?php echo base_url().'user/pet'?>" class="nav-item nav-link">Pet</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="<?php echo base_url().'user/team'?>" class="dropdown-item">Team Kami</a>
                    </div>
                </div>
