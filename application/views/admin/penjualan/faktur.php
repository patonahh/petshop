            ...
            foreach ($faktur as $k) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo anchor('admin/batalPesan/' . $k->id, '<div class="badge badge-danger"><i class="fas fa-trash">Batal</i></div>', "onclick=\"return confirm('Kamu yakin akan membatalkan pemesanan ini?')\"") ?>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
