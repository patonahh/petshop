...
<div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="section-title bg-white text-center text-primary px-3">Makanan Anjing</p>
                <h2 class="mb-5">Produk Makanan Anjing Yang Kami Jual Untuk Peliharaan Kesayangan Anda</h2>
            </div>
            <div class="row gx-4">
